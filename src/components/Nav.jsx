...
export default function Nav() {
   ...
   return (
      <ul className={`navigation ${scrolled ? "scrolled" : ""}`}>
         <li>
            <a className="active" id="om-mig-link" href="#om-mig">
               Om mig
            </a>
         </li>
         <li>
            <a id="kompetencer-link" href="#kompetencer">
               Kompe<span className="mobile-version">-</span>tencer
            </a>
         </li>
         <li>
            <a id="projekter-link" href="#projekter">
               Projekter
            </a>
         </li>
      </ul>
